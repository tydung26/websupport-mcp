...
open questions, and progress. Scope changes, verification results, and answers are recorded *here*,
...
> this file and are not authoritative; nothing below defers to them. Everything needed to *use* or
> *review* the project lives in `README.md` and (from Phase 6) `docs/`.
